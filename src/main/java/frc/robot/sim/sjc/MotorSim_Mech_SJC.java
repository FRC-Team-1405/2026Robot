...
// /**
// * Class to keep all the mechanism-specific objects together and out of the
// main
// * example
// * STOLEN FROM:
// *
// https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/MotionMagic/src/main/java/frc/robot/Mechanisms.java
// */
// public class MotorSim_Mech_SJC {
...
// // Velocity
// MechanismLigament2d VelocityMech =
// mech.getRoot("velocityLineReferencePosition", 0.75, 0.5)
// .append(new MechanismLigament2d("velocityLine", 1, 90, 6, new
// Color8Bit(Color.kAliceBlue)));

// MechanismLigament2d midline = mech.getRoot("midline", 0.7, 0.5)
// .append(new MechanismLigament2d("midline", 0.1, 0, 3, new
// Color8Bit(Color.kCyan)));

// // Position
// MechanismLigament2d arm = mech.getRoot("pivotPoint", 0.25, 0.5)
// .append(new MechanismLigament2d("arm", .2, 0, 0, new
// Color8Bit(Color.kAliceBlue)));
...
// public MotorSim_Mech_SJC(String mechanismName) {
...
// *
// * This utilizes GUI to simulate and display a TalonFX and exists to allow
// users
...
// Divide by 120 to scale
// // motion to
// // fit in the window
// arm.setAngle(position.getValue().in(Rotations) * 360);
// SmartDashboard.putData(mechanismName, mech); // Creates mech2d in
// SmartDashboard
// }
// }