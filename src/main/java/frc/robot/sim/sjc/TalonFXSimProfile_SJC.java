...
class TalonFXSimProfile_SJC extends SimProfile {
     ...
     */
    public TalonFXSimProfile_SJC(final TalonFX talonFX, final double rotorInertia) {
     ...
     */
    public TalonFXSimProfile_SJC(final TalonFX talonFX, final double rotorInertia, final double loadMassKg,
            final double armMeters, final double viscousCoeff, final double motorKt, final int numMotors,
