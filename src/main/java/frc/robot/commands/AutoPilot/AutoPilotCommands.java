...
public class AutoPilotCommands {
        ...
        // Macy find rotation
        public static Supplier<Pose2d> center = () -> new Pose2d(2.5, 4, Rotation2d.fromDegrees(6.7));
        ...
        public static void registerCommands(CommandSwerveDrivetrain drivetrain) {
                ...
                Supplier<Command> MoveTo_pos1_withTracking = () -> new AutoPilotCommand.Builder(
                                ...
                                .withFlipPoseForAlliance(true)
                                .build();
                // Supplier<Command> Stay_Center = () -> new AutoPilotCommand.Builder(pos1,
                // drivetrain, null);
                ...
                // MACY-Command TEST_Center_Score = new SequentialCommandGroup(
